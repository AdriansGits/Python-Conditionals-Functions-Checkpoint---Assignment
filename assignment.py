...
elif temperature >= 32 and temperature <= 90:
...
first_number = int(input("Enter the first whole number: "))
second_number = int(input("Enter the second whole number: "))
third_number = int(input("Enter the third whole number: "))
...
value1 = int(input("Enter the first whole number: "))
value2 = int(input("Enter the second whole number: "))
value3 = int(input("Enter the third whole number: "))
...
c = int(input("Enter the third whole number: "))
...
user_score = int(input("Enter a score from 0 to 100: "))
...
greet_student("Adrian")
greet_student("Sebastian")
greet_student("Charlie")
...
find_lowest(10, 40, 23)
find_lowest(50, 12, 30)
find_lowest(24, 27, 90)
...
compare_three(11, 22, 33)
compare_three(11, 11, 22)
compare_three(11, 11, 11)
...
print(lowest_of_three(6, 12, 54))
print(lowest_of_three(53, 79, 76))
print(lowest_of_three(93, 12, 55))
...
middle = (user_num1 + user_num2 + user_num3) - lowest - highest
...
def get_middle(a, b, c):
    return (a + b + c) - get_highest(a, b, c) - get_lowest(a, b, c)
...
if (a == b and a == highest) or (a == c and a == highest) or (b == c and b == highest):
    print("Tied highest")
else:
